export type LegacySkinLanguage="zh"|"en";

const EN:Record<string,string>={
"返回上一题":"Back","返回首页":"Back to home","上一步":"Back","首页":"Home","重新选择":"Choose again","确认":"Confirm",
"第一步 · 了解肤质":"Step 1 · Understand your skin","第二步 · 基础信息":"Step 2 · Basic information","第三步 · 就医识别":"Step 3 · Safety check","肤质已记录":"Skin profile recorded","鉴别问诊":"Differential assessment",
"在选具体问题之前,先排除这几种情况":"One quick safety check","这几种不属于护肤品能处理的范畴,这一步只做一次——命中任意一项会直接建议就医,不会进入后面的症状选择":"If none of these apply, continue as usual. If one does apply, we’ll show a risk note first, but you can still finish the skin test.",
"建议就医":"Risk note","这个特征超出了护肤品能处理的范围":"This feature is outside what skincare products can address","重新开始演示":"Continue skin test",
"这类情况通常需要专业检查(必要时刮片、皮肤镜或活检)才能确诊,继续用护肤品自行判断和护理不仅无效,还可能延误规范治疗的时机。建议尽快挂皮肤科明确诊断,再决定后续方案。":"Conditions like this usually require a professional examination — sometimes including a scraping, dermoscopy, or biopsy — before they can be confirmed. Trying to judge or manage them with skincare alone may be ineffective and could delay appropriate treatment. Please consider seeing a dermatologist to clarify the diagnosis before deciding what to do next.",
"洗完脸不涂任何东西,1小时后T区和两颊分别是什么状态?":"One hour after cleansing, without applying anything, how do your T-zone and cheeks feel?","T区出油,两颊偏干或正常":"The T-zone is oily; cheeks are dry or normal","混合性":"Combination","整脸都出油":"My whole face gets oily","油性":"Oily","整脸紧绷、有点起皮":"My whole face feels tight or slightly flaky","干性":"Dry","比较舒适,没什么明显感觉":"Comfortable, with no obvious oiliness or tightness","中性":"Balanced",
"换新产品时,皮肤容易泛红刺痛,还是基本没什么反应?":"When trying a new product, does your skin easily become red or sting?","比较容易有反应":"It reacts fairly easily","敏感叠加":"Sensitivity-prone","基本没什么反应":"It usually does not react","非敏感":"Not especially sensitive","2个问题，帮助后续建议更贴近你的真实状态":"Two quick questions help tailor the next steps to your skin.",
"你的年龄段是?":"What is your age range?","年龄会影响诊断权重——同样症状在不同年龄段更可能对应的病因不一样":"Age helps adjust the weighting because the same symptom can have different likely causes at different ages.","18岁以下":"Under 18","18-30岁":"18–30","30-45岁":"30–45","45岁以上":"45+",
"性别":"Sex","用于判断部分周期性/激素相关问题是否适用,以及用药建议的安全边界":"Used only where cycle- or hormone-related questions and safety guidance depend on sex.","女":"Female","男":"Male",
"目前有没有怀孕或哺乳?":"Are you currently pregnant or breastfeeding?","这一步是用药建议前的安全检查,不影响病因诊断本身":"This is a safety check for treatment guidance and does not change the underlying assessment.","是,目前怀孕或哺乳期":"Yes, pregnant or breastfeeding","没有":"No","怀孕/哺乳期":"Pregnant / breastfeeding",
...
"边界清楚的红斑,上面覆盖较厚的银白色鳞屑,撕掉鳞屑容易点状出血":"A sharply defined red patch with thick silvery scale that may pinpoint-bleed when the scale is removed","银屑病":"Psoriasis","属于需要系统性皮肤科管理的慢性病,鳞屑厚度和点状出血是和普通干燥脱皮最大的区别。":"This is a chronic condition that generally needs dermatologic management. Thick scale and pinpoint bleeding help distinguish it from ordinary dryness or flaking.",
"有边界清楚的色素完全脱失斑(不是变浅,是完全变白)":"A clearly defined patch with complete loss of pigment (fully white, not just lighter)","白癜风":"Vitiligo","和色沉、晒斑的方向相反,容易被误判成\"美白过度\",不属于护肤品能干预的范畴。":"This is the opposite of pigmentation or sun spots and can be mistaken for excessive lightening. It is not something skincare products can meaningfully treat.",
"成簇的小水疱,伴刺痛或灼烧感":"Clusters of small blisters with stinging or burning","疱疹类病毒感染":"Herpes-family viral infection","病毒感染,和痤疮/接触性皮炎的水疱表现需要鉴别,不适合按护肤流程处理。":"A viral infection can produce blisters that need to be distinguished from acne or contact dermatitis, so it should not be handled as a routine skincare issue.",
"风团样红斑,通常24小时内自行消退,但此起彼伏反复出现":"Hive-like red welts that usually fade within 24 hours but recur elsewhere","荨麻疹":"Urticaria (hives)","起消速度是关键特征,和接触性皮炎、普通泛红的病程明显不同。":"How quickly the welts appear and disappear is an important clue and differs from the course of contact dermatitis or ordinary redness.",
"长期日晒部位(面部/手背)出现粗糙鳞屑性斑块,摸起来像砂纸":"A rough, scaly, sandpaper-like patch on a chronically sun-exposed area such as the face or back of the hands","日光性角化病":"Actinic keratosis","属于癌前病变,检测到疑似特征应立即建议就医,而不是继续走护肤建议路径。":"This can be a precancerous lesion. If the pattern is suspected, medical assessment should take priority over skincare recommendations.",
"你的肌肤分析":"Your skin analysis","先做这三件事":"Start with these three steps","当前优先方向：":"Current priority: ","1 · 先简化":"1 · Simplify first","2 · 保留基础":"2 · Keep the basics","3 · 再做选择":"3 · Choose selectively","你的成分方向":"Your ingredient direction","优先看的产品":"Products to consider first","护肤建议":"Skincare guidance","合并护肤建议":"Combined skincare guidance","就医提示":"Medical note","就医时可咨询的治疗方向":"Treatment options to discuss with a clinician",
"证据拆解 · Confidence Engine":"Evidence breakdown · Confidence Engine","基础":"Base","支持":"Support","矛盾":"Contradiction","不确定":"Uncertainty","高":"High","中":"Medium","低":"Low","风险信号":"Risk signal","未观察到":"Not observed","矛盾信号":"Contradicting signal",
"导出 PDF 报告":"Export PDF report","查看成分匹配分析":"View ingredient match analysis","从产品数据库为我匹配":"Match products for me","重新开始":"Start over","成分匹配分析 · 第一步":"Ingredient match · Step 1","先告诉我们你在用哪一瓶":"Which product are you using?","数据完整度":"Data completeness","未识别":"Unrecognised","结论":"Conclusion","冲突":"Conflict","一致":"Match","低权重":"Lower weight","未标准化":"Unstandardised","中性":"Normal",
"为你推荐 · 本地产品数据库":"Recommended for you · Product database","数据来源":"Source","完整配方":"Full formula","部分配方":"Partial formula","证据不足":"Insufficient evidence","有效证据":"Evidence","方向冲突":"Conflicting direction","为什么不是黑箱推荐?":"Why this is not a black-box recommendation","打分逻辑":"Scoring logic","全部":"All","搜索品牌或产品名":"Search brand or product","再显示 24 款":"Show 24 more","Formula DNA · 配方结构":"Formula DNA · Formula structure","酒精":"Alcohol","肤感":"Skin feel","可信度":"Confidence",
"温和":"Gentle","中等":"Moderate","非处方":"Over the counter","处方(视情况)":"Prescription (if appropriate)","就医建议":"Medical guidance"
};

const ZH_OVERRIDE:Record<string,string>={
"第三步 · 就医识别":"第三步 · 安全提示",
"在选具体问题之前,先排除这几种情况":"先确认一个安全问题",
"这几种不属于护肤品能处理的范畴,这一步只做一次——命中任意一项会直接建议就医,不会进入后面的症状选择":"如果以下情况都没有，直接继续测试；如果有，我们会先提示风险，但你仍然可以继续完成肤质测试。",
"建议就医":"风险提示",
"重新开始演示":"继续后续测试"
};
...
[/^特征更符合:(.+)$/,(m)=>`This pattern is more consistent with: ${EN[m[1].trim()]||m[1].trim()}`],
[/^你的肌肤分析\s*·\s*(.+)$/,(m)=>`Your skin analysis · ${m[1].split(" / ").map(x=>EN[x]||x).join(" / ")}`]
];

function translateWhole(text:string,language:LegacySkinLanguage){
 const trimmed=text.trim();
 if(!trimmed)return text;
 if(language==="zh"){
  const out=ZH_OVERRIDE[trimmed];
  if(!out)return text;
...
export function legacySkinLanguage():LegacySkinLanguage{
 if(typeof window==="undefined")return"zh";
 return window.localStorage.getItem("skincare101-language")==="en"?"en":"zh";
}

export function shouldLocalizeLegacySkin(){
 if(typeof window==="undefined")return false;
 return new URLSearchParams(window.location.search).get("view")==="profileBuilder";
}

export function localizeLegacySkinText(value:string,language:LegacySkinLanguage=legacySkinLanguage()){
 if(!shouldLocalizeLegacySkin())return value;
 let direct=translateWhole(value,language);
 if(direct!==value)return direct;
 if(language==="zh")return value;
 // Translate known phrases embedded in longer UI strings without touching data keys or values.
 const entries=Object.entries(EN).sort((a,b)=>b[0].length-a[0].length);
 let out=value;
 for(const[zh,en]of entries){if(zh.length>=4&&out.includes(zh))out=out.split(zh).join(en)}
 return out;
}

export function localizeLegacySkinValue<T>(value:T,language:LegacySkinLanguage=legacySkinLanguage()):T{
 if(typeof value==="string")return localizeLegacySkinText(value,language) as T;
 if(Array.isArray(value))return value.map(item=>localizeLegacySkinValue(item,language)) as T;
 return value;
}
