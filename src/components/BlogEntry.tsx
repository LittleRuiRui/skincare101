...
export default function BlogEntry() {
  ...
  return <section style={{marginTop:24,border:"1px solid #D9D0BC",borderRadius:22,overflow:"hidden",background:"#FBF6EA"}}>
    <a href="/blog/" style={{display:"block",textDecoration:"none",color:"#263027"}}>
      ...
      <div style={{padding:20}}>
        ...
        <p style={{fontSize:16,lineHeight:1.65,margin:"0 0 14px"}}>{t("12 篇完整指南：湿热天气、防晒、成分和产品选择，每篇附资料来源。","12 practical guides on humid weather, sunscreen, ingredients and product choices, with sources. Articles are in Chinese.")}</p>
