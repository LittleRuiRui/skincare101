...
const LegacyQuestionnaireI18nBridge=React.lazy(()=>import("./LegacyQuestionnaireI18nBridge"));
const LegacyReferralUxBridge=React.lazy(()=>import("./LegacyReferralUxBridge"));
const LegacyResultsI18nBridge=React.lazy(()=>import("./LegacyResultsI18nBridge"));
